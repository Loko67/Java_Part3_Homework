...
public class TestTestSuiteCrmGeekBrains {
    ...
    void projectСreation() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='crm_project[name]']")).sendKeys("name110");
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[text()='Укажите организацию']")).click();
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[text()='123test']")));
        driver.findElement(By.xpath("//div[text()='123test']")).click();
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='select2-container select2']/a")));
        driver.findElement(By.xpath("//div[@class='select2-container select2']/a")).click();
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='select2-drop']/div/input")));
        driver.findElement(By.xpath("//div[@id='select2-drop']/div/input")).sendKeys("Иванов Иван");
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()='Иванов Иван']")));
    ...
    void creationContactPersonInOrganizationWithMinimallyFilledInformation() {
        ...
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()='123test']")));
        ...
        Assertions.assertTrue("Все Контактные лица".equals(driver.findElement(By.cssSelector("div.btn>h1")).getText()));
        driver.close();
    }
